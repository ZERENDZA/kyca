...
export async function POST(req: NextRequest) {
  ...
  const membershipLabel =
    membership_type === "premium" ? "Premium Member" :
    membership_type === "lifetime" ? "Lifetime Member" :
    "Basic Member"
            ...
            <tr>
              <td style="padding:40px;">
                ...
                <p style="margin:0 0 16px;font-size:15px;color:#5c4a3a;line-height:1.7;">
                  Thank you for joining the Kamwe Youth Connect Association. Your registration as a <strong>${membershipLabel}</strong> has been received and confirmed.
                </p>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="background:#f5f0eb;border-radius:12px;margin-bottom:24px;">
                  <tr><td style="padding:20px 24px;">
                    ...
                    <p style="margin:0;font-size:18px;font-weight:700;color:#3d2b1f;">${membershipLabel}</p>
                  </td></tr>
                </table>
                <p style="margin:0 0 16px;font-size:15px;color:#5c4a3a;line-height:1.7;">
  ...
  try {
    const res = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        from: "KYCA <noreply@yourdomain.com>", // ← update this
        to: email,
